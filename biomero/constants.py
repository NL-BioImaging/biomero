...
class slurm_env:
    ...
    BIOMERO_REMOTE_SHALLOWER_IMAGE = "BIOMERO_REMOTE_SHALLOWER_IMAGE"
    BIOMERO_REMOTE_SHALLOWER_VERSION = "BIOMERO_REMOTE_SHALLOWER_VERSION"
    BIOMERO_REMOTE_SHALLOWER_WORKERS = "BIOMERO_REMOTE_SHALLOWER_WORKERS"
    BIOMERO_REMOTE_SHALLOWER_PARTITION = "BIOMERO_REMOTE_SHALLOWER_PARTITION"
    BIOMERO_REMOTE_SHALLOWER_MEM = "BIOMERO_REMOTE_SHALLOWER_MEM"
    BIOMERO_REMOTE_SHALLOWER_TIME = "BIOMERO_REMOTE_SHALLOWER_TIME"
