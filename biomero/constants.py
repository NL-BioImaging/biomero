...
class slurm_env:
    BIOMERO_REMOTE_SHALLOW_ZARR = "BIOMERO_REMOTE_SHALLOW_ZARR"
    BIOMERO_RESULT_NORMALIZER_IMAGE = "BIOMERO_RESULT_NORMALIZER_IMAGE"
    BIOMERO_RESULT_NORMALIZER_VERSION = "BIOMERO_RESULT_NORMALIZER_VERSION"
    BIOMERO_RESULT_NORMALIZER_WORKERS = "BIOMERO_RESULT_NORMALIZER_WORKERS"
    BIOMERO_RESULT_NORMALIZER_PARTITION = "BIOMERO_RESULT_NORMALIZER_PARTITION"
    BIOMERO_RESULT_NORMALIZER_MEM = "BIOMERO_RESULT_NORMALIZER_MEM"
    BIOMERO_RESULT_NORMALIZER_TIME = "BIOMERO_RESULT_NORMALIZER_TIME"

    BIOMERO_SLURM_CONFIG_FILE = "BIOMERO_SLURM_CONFIG_FILE"
    BIOMERO_DETACHED_WORKFLOWS = "BIOMERO_DETACHED_WORKFLOWS"
    BIOMERO_MAX_ACTIVE_WORKFLOWS = "BIOMERO_MAX_ACTIVE_WORKFLOWS"
    BIOMERO_SUPERVISOR_POLL_SECONDS = "BIOMERO_SUPERVISOR_POLL_SECONDS"
    ...
    BIOMERO_PULL_TIME = "BIOMERO_PULL_TIME"
    BIOMERO_PULL_CONCURRENCY = "BIOMERO_PULL_CONCURRENCY"
    BIOMERO_PULL_PARTITION = "BIOMERO_PULL_PARTITION"
